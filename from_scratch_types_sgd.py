...
if __name__ == "__main__":
    ...
    train_dataset = PollenTypeDataset(X_train,y_train,train_transforms)
    ...
    print("Test Top 1 accuracy: " + str(top_k_accuracy_score(y_true_list, y_pred_list, k=1,labels=[x for x in range(0,274)])))
    print("Test Top 3 accuracy: " + str(top_k_accuracy_score(y_true_list, y_pred_list, k=3,labels=[x for x in range(0,274)])))
    print("Test Top 5 accuracy: " + str(top_k_accuracy_score(y_true_list, y_pred_list, k=5,labels=[x for x in range(0,274)])))
